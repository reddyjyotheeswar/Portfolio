...
📧 jvotheeswar1127@gmail.com | 📱 +91 7382609486  
🔗 linkedin.com/in/njreddy | 🔗 github.com/reddyjyotheeswar  
...
Results-driven SDET with 5+ years of experience at Infosys, specializing in test automation framework development using Selenium and Java. Proven track record in insurance domain testing, delivering comprehensive quality solutions across Claim Center, Policy Management, and Claims Processing systems. Expert in designing scalable test strategies, implementing CI/CD pipelines, and driving quality excellence in Agile environments. Reduced defect leakage by 25% and achieved 70% automation coverage for critical business flows through systematic automation approach. Passionate about bridging the gap between development and testing while ensuring scalable, maintainable automation solutions.

---

## TECHNICAL SKILLS

**Test Automation:** Selenium WebDriver, Java, TestNG, JUnit, Page Object Model, Data-Driven Testing, Hybrid Framework, Selenium Grid  
**API Testing:** REST Assured, Postman, SOAP UI, REST API, SOAP API, JSON Schema Validation  
**CI/CD & DevOps:** Jenkins, GitHub Actions, Maven, Gradle, Git, Docker, CI/CD Pipelines, Version Control  
**Testing Tools:** Jira, qTest, Bug Tracking Tools, Test Management  
...
- Developed Selenium Java automation framework using Page Object Model, achieving 70% test coverage for critical business flows
- Reduced regression testing time by 60% through automation implementation and CI/CD integration with Jenkins
...
**Insurance Test Automation Framework** | GitHub: github.com/reddyjyotheeswar/insurance-test-automation
- Developed hybrid test automation framework using Selenium Java, TestNG, and Maven for insurance domain applications
...
- Implemented Jenkins pipeline with Selenium, Maven, and Docker integration
- Automated test execution and reporting with email notifications
- Reduced deployment testing time by 60% through automation
...
- Strong domain expertise in insurance testing with 5+ years experience
- Expertise in test automation framework development and maintenance
- Cross-functional collaboration and technical leadership skills
